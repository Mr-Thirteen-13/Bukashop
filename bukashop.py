# python 3.7
# author: Karjok Pangesty (https://github.com/Mr-Thirteen-13)
# dimodifikasi oleh ThuanTiggaBellass(https://github.com/Mr-Thirteen-13)
# source code: https://github.com/Mr-Thirteen-13/Bukashop
...
class Bukasop:
    ...
    |_)|_| |<(_|\033[0m__)| |(_)|  \033[95mfb.me/100045683043717
    |\033[0mBukalapak x Shopee price sorter
    
    MOD: \033[9{mod}mThuanTiggaBellass \033[9{mod2}m(bastianSaputra)\033[0m
    ''')
		self.q=input('[?] query: ')
